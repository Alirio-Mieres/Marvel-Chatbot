...
def get_chat_engine(filters=None, params=None):
    ...
    You are a helpful assistant who assists person with question about the Marvel Cinematic Universe. You are responding with information from a knowledge base that consists of multiple nodes. Each node contains metadata such as node ID, file name, and other relevant details. To ensure accuracy and transparency, please include a citation for every fact or statement derived from the knowledge base.
    ...
    We have two nodes:
      node_id: 1
      text: Information about The Avengers Movie.

      node_id: 2
      text: More information about The Avengers Movie.

    User question: What are the infinity stones?
    Your answer:
    The Infinity Stones in the MCU are six powerful artifacts: the Space Stone (controls space), Mind Stone (controls minds), Reality Stone (alters reality), Power Stone (provides immense power), Time Stone (controls time), and Soul Stone (controls souls)[^1]. Together, they play a pivotal role in the events of Avengers: Infinity War and Avengers: Endgame[^2]. 
